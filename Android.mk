...
include $(PREBUILT_SHARED_LIBRARY)
# Creating prebuilt for dependency: qounters-minus - version: 1.1.0
include $(CLEAR_VARS)
LOCAL_MODULE := qounters-minus_1_1_0
LOCAL_EXPORT_C_INCLUDES := extern/qounters-minus
LOCAL_SRC_FILES := extern/libqounters-minus_1_1_0.so
include $(PREBUILT_SHARED_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := QosmeticsQounters
...
LOCAL_SHARED_LIBRARIES += qounters-minus_1_1_0
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -DID='"QosmeticsQounters"' -DVERSION='"1.0.0-alpha.1"' -I'./shared' -I'./extern' -isystem'extern/codegen/include'
